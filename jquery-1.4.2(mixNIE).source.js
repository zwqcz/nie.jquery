...
*	<pre>
*	最新版本：<a href="http://res.nie.netease.com/comm/js/jquery(mixNIE).last.js">http://res.nie.netease.com/comm/js/jquery(mixNIE).last.js</a>
*	jquery mix NIE:
...
nie.util = {
	...
	**/
	...
	copyRight:function(){
		...
		var agePermision="<p style=\"text-align:center;\">本游戏适合{age}岁以上的玩家进入</p>";
		var suggestion='<p style="text-align:center;">积极健康的游戏心态是健康游戏的开端，{sug}，请您合理控制游戏时间，避免沉溺游戏影响生活，注意自我保护，防范网络陷阱。</p>';
		var email='<p class="l4" style="text-align:center;">文化部网络游戏举报和联系电子邮箱：<a href="mailto:wlwh@vip.sina.com">wlwh@vip.sina.com</a></p>';
		var rule='<p class="l5" style="text-align:center;"><a target="_blank" href="http://nie.163.com/news/2010/6/9/442_216957.html">《互联网文化管理暂行规定》</a>	{bcode}</p>';
		var passport='《网络文化经营许可证》文网文『2008』080号';
		var bcodes={
			xyq:'文网游备字【2005】017号',
			xy2:'文网游备字【2005】016号',
			xy3:'文网备字[2009]003号',
			dt:'文网备字[2007]12号',
			ff:'文网游备字[2010]C-RPG001号',
			popogame:'文网备字[2008]011号',
			fj:'文网游备字[2010]C-CSG002号',
			rich:'文网游备字[2010]C-CSG002号',
			sg:'文网游备字[2010]W-SLG013号',
			st:'文网游备字[2010]C-CSG004号',
			zg:'文网游备字[2010]W-SLG012号',
			ball:'文网游备字[2010]C-CSG005号'
		};		
		if (o) {	 
		  var txt="",pic="",age='16',sug='本游戏故事情节设置紧凑';
		  switch(nie.config.site){
			  case 'nie':
			    agePermision='';
				suggestion='';
		  ...
		  if(!isIndex){
				...
				+(typeof bcodes[nie.config.site]=='undefined'?'':''+bcodes[nie.config.site])+'&nbsp;&nbsp; 文网文『2008』080号</p>');
		  }else{
