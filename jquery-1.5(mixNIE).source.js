...
nie.use=function(module,callBack){	
	var modules = module.sort().toString(),
		url="http://res.nie.netease.com/comm/js/"+((window.location.href.indexOf("http")!=0)?"use.php?p="+modules:"cache/"+$.md5(modules)+".js");
	...
	**/
	...
	copyRight:function(){				
		...
		if(o.length!=0){
          ...
          if(/.*\.163\.com\/($|index\.html$|boot\.html$)/.test(window.location.href.split('?',1)[0])){			
