	...
	nie.util.share=nie.util.share||function(){	
		var _href="javascript:;",
		    ...
		    o={		
				...
				args:{
					...
					*/
					defShow:[22,1,2,3],//(nie.config.site=="xy2")?[1,2,3,8]:[5,1,2,3],
					defShow2:[22,1,2,3,8,4],//(nie.config.site=="xy2")?[1,2,3,5,8]:[5,1,2,3,8,4],
					moreShow:[22,5,1,2,3,4,6,7,8,9,10,11,13],
		...
		o.init=function(){
		   ...
		   if(!nie.util.share_css){
			   $.include("http://res.nie.netease.com/comm/js/nie/util/share/share.v2.css");
