...
/**
*	滚动条滚动。<br>
*	<a href="nie.use.html"><font color="red">nie.use模块：</font></a>util.scrollTo<br>
*   version 1.4.2<br>
*   说明：<a href="http://plugins.jquery.com/project/ScrollTo" target="_blank">jquery说明</a>，<a href="http://flesler.blogspot.com/2007/10/jqueryscrollto.html" target="_blank">官方说明（需要翻墙）</a><br>
*	<pre>
...
*	@param {String, Number, DOMElement, jQuery, Object} data target Where to scroll the matched elements.
**/
(function($){
